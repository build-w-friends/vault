/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=production` (hash: eb01c5eeade66a31f4589ca9300419c2)
// Runtime types generated with workerd@1.20260825.1 2026-08-31 nodejs_compat
interface __BaseEnv_Env {
  DB: D1Database;
  MASTER_KEY_PRIMARY: SecretsStoreSecret;
  MASTER_KEY_SECONDARY: SecretsStoreSecret;
  BOOTSTRAP_TOKEN: SecretsStoreSecret;
  ACTIVE_MASTER_KEY: "secondary";
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, "ACTIVE_MASTER_KEY" | "AUDIT_RETENTION_DAYS">
  > {}
}
